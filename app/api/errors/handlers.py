...
def request_validation_error_handler(
    ...
    return JSONResponse(
        ...
        content={
            'message': f'Ошибка валидации отправленных данных.',
            'errors': exc.errors(),
            'body': exc.body
        }
    )
...
def validation_error_handler(
    ...
    return JSONResponse(
        ...
        content={'message': f'Внутренняя ошибка сервера.'}
    )


def external_api_error_handler(request: Request, exc: ExternalAPIError) -> JSONResponse:
    ...
    if exc.status_code == 402:
        ...
        content={'message': 'Код валюты не найден. ' 
